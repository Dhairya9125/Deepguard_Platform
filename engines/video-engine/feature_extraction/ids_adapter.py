...
Usage:
    from feature_extraction.ids_adapter import load_ids_components, IDSComponents
...
def load_ids_components(
    ...
    # ── IDS imports ─────────────────────────────────────────────────────────
    try:
        from preprocessing.image_normalizer   import ImageNormalizer           # noqa: PLC0415
        from preprocessing.frequency_analyzer import FrequencyAnalyzer         # noqa: PLC0415
        from feature_extraction.spatial_branch    import ClipSpatialBranch     # noqa: PLC0415
        from feature_extraction.frequency_branch  import EfficientNetFrequencyBranch  # noqa: PLC0415
        from feature_extraction.discrepancy_branch import DiscrepancyBranch    # noqa: PLC0415
        from feature_extraction.noise_branch      import NoiseResidualBranch   # noqa: PLC0415
        from feature_extraction.fingerprint_branch import FingerprintBranch    # noqa: PLC0415
        from fusion.ids_fusion_engine             import IDSFusionEngine        # noqa: PLC0415
        from localization.localization_engine     import LocalizationEngine     # noqa: PLC0415
    except ImportError as exc:
        raise ImportError(
